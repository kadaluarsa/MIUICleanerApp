...
public class CoreService extends Service {
    ...
    public static final String ACTION_CLEAN_AND_EXIT = "com.kadaluarsa.cleaner.CLEAN_AND_EXIT";
    ...
    private class TaskScan extends AsyncTask<Void, Integer, List<AppProcessInfo>> {
        ...
        protected List<AppProcessInfo> doInBackground(Void... params) {
            ...
            for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessList) {
                ...
                Integer[] r12 = new Integer[3];
                int j = this.mAppCount + 1;
                this.mAppCount = j;

                r12[0] = j;
                r12[1] = appProcessList.size();
                r12[2] = (int) memsize;
                publishProgress(r12);
        ...
        protected void onProgressUpdate(Integer... values) {
            if (mOnActionListener != null) {
                mOnActionListener.onScanProgressUpdated(CoreService.this, values[0], values[1], values[2]);
            }
        }
