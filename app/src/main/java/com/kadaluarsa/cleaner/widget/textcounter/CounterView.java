package com.kadaluarsa.cleaner.widget.textcounter;
...
import com.kadaluarsa.cleaner.widget.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.kadaluarsa.cleaner.widget.textcounter.formatters.DecimalFormatter;
import com.kadaluarsa.cleaner.widget.textcounter.formatters.IntegerFormatter;
import com.kadaluarsa.cleaner.widget.textcounter.formatters.NoFormatter;
...
public class CounterView extends TextView {
    ...
    public void setCurrentTextValue(final float number) {
    ...
    /**
     * Set the counterType. See {@link com.github.premnirmal.textcounter.CounterType} for further details
     * @param counterType
     */
    ...
    /**
     * Allow the view to auto format the number depending on the {@link com.github.premnirmal.textcounter.CounterType}
    ...
    /**
     * Set a custom {@link com.github.premnirmal.textcounter.Formatter} to format the text before
